...
<div id="gbx-main-gallery span13">
    ...
    <div class="set-info"><h3><?php    echo $fs->getFileSetName()?></h3><?php   echo t('by ')?><a href="<?php    echo View::url('/profile',$setOwner->getUserID())?>"><?php    echo $username?></a> &#8226; <a href="<?php    echo View::url('/gallerybox/user',$setOwner->getUserID())?>"><?php   echo t('Gallery')?></a></div>
