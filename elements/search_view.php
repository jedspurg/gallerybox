...
<div id="gbx-main-gallery">
 ...
 <div id="gbx-page-name"><h3><?php   echo t('Search Results for')?> <em><?php    echo $keywords?></em></h3></div><div id="gallery-search"><form id="GallerySearchForm" method="post" action="<?php    echo $this->action('search')?>"><input type="text" name="keywords" id="keywords" value=""/><input type="submit" value="Search" class="btn primary"/></form></div>
    ...
    <div class="clearbox"></div>
        ...
        ?>
          ...
          <?php  
			$summary = $searchPaging->getSummary();
			if ($summary->pages > 1):
			$paginator = $searchPaging->getPagination();
