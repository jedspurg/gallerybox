...
<div id="gbx-main-gallery">
 ...
 <div id="gbx-page-name"><h3>Search Results for <em><?php  echo $keywords?></em></h3></div><div id="gallery-search"><form id="GallerySearchForm" method="post" action="<?php  echo $this->action('search')?>"><input type="text" name="keywords" id="keywords" value=""/><input type="submit" value="Search" class="btn primary"/></form></div>
