...
<div id="gallery-search"><form id="GallerySearchForm" method="post" action="<?php  echo $this->action('search')?>"><input type="text" name="keywords" id="keywords" value=""/><input type="submit" value="Search" class="btn primary"/></form></div>
