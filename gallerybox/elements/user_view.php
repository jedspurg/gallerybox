...
<div class="row">    
    <div id="gbx-sidebar" class="span3">
        ...
        <h5><small>by </small><?php  echo $username?></h5>
            ...
            <a href="<?php  echo View::url('/profile',$user->getUserID())?>" class="btn small pull-right u-button"><strong>Profile</strong><span class="icon user"></span></a>
            <a href="<?php  echo View::url('/gallerybox/user',$user->getUserID())?>" class="btn small pull-right u-button"><strong>Gallery</strong><span class="icon book"></span></a>
            </div>
        ...
        <?php if(Config::get(GBX_ALLOW_RSS)==1){?>
         ...
         <div id="gbx-rss">
            <div class="clearfix">
            <a href="<?php  echo View::url('/gbxrss',$user->getUserID())?>" class="btn">Subscribe<span class="icon rss"></span></a>
            </div>
        </div>
        <?php }?>
