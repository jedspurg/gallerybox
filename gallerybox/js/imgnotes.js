...
(function($) {
	...
	function appendnote(note_data){
		...
		if(isEditor){
			del_action='&nbsp;&nbsp;<a id="'+note_data.x1+'_'+note_data.y1+'" data-controls-modal="delete-note-modal" data-backdrop="static" class="close noteIDcopy" data-placement="below" rel="twipsy" title="delete note">×</a>';	
		}else{
			del_action='';
		}
		...
		note_text_div = $('<div class="notep" >'+note_data.note+del_action+'</div>').css({ left: note_left + 'px', top: note_p_top + 'px'});
